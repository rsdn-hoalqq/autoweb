          ...
          <div class="panel-heading headings">DANH MỤC QUẢN LÝ</div>
            <ul class="list-group">
              <li class="list-group-item">
                ...
                <a href="<?php echo e(route('addCate')); ?>" class="btn btn-success clIcon" data-toggle="tooltip" title="Tạo mới chuên mục!">
              ...
              <li class="list-group-item">
                ...
                <a href="<?php echo e(route('addCate')); ?>" class="btn btn-success clIcon" data-toggle="tooltip" title="Tạo mới Khóa học!">
                  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                </a>
              </li>
              <li class="list-group-item">
